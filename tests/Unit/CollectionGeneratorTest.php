 ...
 */
class CollectionGeneratorTest extends BaseUnitTestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->generator = new CollectionGenerator(
    ...
    private function prepareMockForAuthor()
    {
        $this->containerMock->shouldReceive('getProvider')
            ->with(Mockery::type(Author::class))->twice()->andReturn(new AuthorProvider);
        ...
        $this->settingsMock->shouldReceive('dataCollectionLinkSingle')->twice()
    ...
    {
        $this->containerMock->shouldReceive('getProvider')
            ->with(Mockery::type(Comment::class))->twice()->andReturn(new CommentProvider);
        ...
        $this->settingsMock->shouldReceive('dataCollectionLinkCollection')->twice()
